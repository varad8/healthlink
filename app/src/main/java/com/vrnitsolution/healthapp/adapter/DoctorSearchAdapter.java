...
public class DoctorSearchAdapter extends RecyclerView.Adapter<DoctorSearchAdapter.DoctorViewHolder> {
    ...
    public DoctorSearchAdapter(Context context, ArrayList<Doctors> doctors, OnDoctorProfileClickListner onDoctorProfileClickListner) {
    ...
    @NonNull
    @Override
    public DoctorSearchAdapter.DoctorViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.item_doctor_admin,parent,false);
        return new DoctorSearchAdapter.DoctorViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull DoctorSearchAdapter.DoctorViewHolder holder, int position) {
        ...
        holder.accountstatus.setText(doctors1.getSpecialistIn());
