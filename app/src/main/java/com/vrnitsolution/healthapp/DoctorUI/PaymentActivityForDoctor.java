...
public class PaymentActivityForDoctor extends AppCompatActivity implements PaymentIntentAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payment_for_doctor);
    ...
    private void fetchUserPayments(String uid) {
        ...
        Query query = db.collection("Payment").whereEqualTo("doc_id", uid);
